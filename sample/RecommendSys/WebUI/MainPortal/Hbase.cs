      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter20 in Success)
            {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                {
                  byte[] _key23;
                  ColumnDescriptor _val24;
                  _key23 = iprot.ReadBinary();
                  _val24 = new ColumnDescriptor();
                  _val24.Read(iprot);
                  Success[_key23] = _val24;
                }
                iprot.ReadMapEnd();
              }
            } else { 
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter25 in Success.Keys)
            {
              oprot.WriteBinary(_iter25);
              Success[_iter25].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TRegionInfo _iter29 in Success)
            {
              _iter29.Write(oprot);
            }
            oprot.WriteListEnd();
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  ColumnDescriptor _elem32;
                  _elem32 = new ColumnDescriptor();
                  _elem32.Read(iprot);
                  ColumnFamilies.Add(_elem32);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (ColumnFamilies != null && __isset.columnFamilies) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (ColumnDescriptor _iter33 in ColumnFamilies)
          {
            _iter33.Write(oprot);
          }
          oprot.WriteListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (byte[] _iter38 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter38);
            oprot.WriteBinary(Attributes[_iter38]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TCell _iter42 in Success)
            {
              _iter42.Write(oprot);
            }
            oprot.WriteListEnd();
  ...
  public partial class getVer_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i44 = 0; _i44 < _map43.Count; ++_i44)
                {
                  byte[] _key45;
                  byte[] _val46;
                  _key45 = iprot.ReadBinary();
                  _val46 = iprot.ReadBinary();
                  Attributes[_key45] = _val46;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter47 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter47);
            oprot.WriteBinary(Attributes[_iter47]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TCell _iter51 in Success)
            {
              _iter51.Write(oprot);
            }
            oprot.WriteListEnd();
  ...
  public partial class getVerTs_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i53 = 0; _i53 < _map52.Count; ++_i53)
                {
                  ...
                  _val55 = iprot.ReadBinary();
                  Attributes[_key54] = _val55;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter56 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter56);
            oprot.WriteBinary(Attributes[_iter56]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TCell _iter60 in Success)
            {
              _iter60.Write(oprot);
            }
            oprot.WriteListEnd();
  ...
  public partial class getRowWithColumns_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter78 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter78);
            oprot.WriteBinary(Attributes[_iter78]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter82 in Success)
            {
              _iter82.Write(oprot);
            }
            oprot.WriteListEnd();
  ...
  public partial class getRowTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter87 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter87);
            oprot.WriteBinary(Attributes[_iter87]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter91 in Success)
            {
              _iter91.Write(oprot);
            }
            oprot.WriteListEnd();
  ...
  public partial class getRowWithColumnsTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter99 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter100 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter100);
            oprot.WriteBinary(Attributes[_iter100]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter104 in Success)
            {
  ...
  public partial class getRows_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter113 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter113);
            oprot.WriteBinary(Attributes[_iter113]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter117 in Success)
            {
  ...
  public partial class getRowsWithColumns_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i125 = 0; _i125 < _map124.Count; ++_i125)
                {
                  byte[] _key126;
                  byte[] _val127;
                  _key126 = iprot.ReadBinary();
                  _val127 = iprot.ReadBinary();
                  Attributes[_key126] = _val127;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter130 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter130);
            oprot.WriteBinary(Attributes[_iter130]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter134 in Success)
            {
  ...
  public partial class getRowsTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter143 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter143);
            oprot.WriteBinary(Attributes[_iter143]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter147 in Success)
            {
  ...
  public partial class getRowsWithColumnsTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter159 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter160 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter160);
            oprot.WriteBinary(Attributes[_iter160]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter164 in Success)
            {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  Mutation _elem167;
                  _elem167 = new Mutation();
                  _elem167.Read(iprot);
                  Mutations.Add(_elem167);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Mutations != null && __isset.mutations) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (Mutation _iter172 in Mutations)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter173 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter173);
            oprot.WriteBinary(Attributes[_iter173]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class mutateRowTs_args : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  Mutation _elem176;
                  _elem176 = new Mutation();
                  _elem176.Read(iprot);
                  Mutations.Add(_elem176);
                }
                iprot.ReadListEnd();
              }
            } else { 
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i178 = 0; _i178 < _map177.Count; ++_i178)
                {
                  byte[] _key179;
                  byte[] _val180;
                  _key179 = iprot.ReadBinary();
                  _val180 = iprot.ReadBinary();
                  Attributes[_key179] = _val180;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Mutations != null && __isset.mutations) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.Struct, Mutations.Count));
          foreach (Mutation _iter181 in Mutations)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter182 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter182);
            oprot.WriteBinary(Attributes[_iter182]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  BatchMutation _elem185;
                  _elem185 = new BatchMutation();
                  _elem185.Read(iprot);
                  RowBatches.Add(_elem185);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (RowBatches != null && __isset.rowBatches) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (BatchMutation _iter190 in RowBatches)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter191 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter191);
            oprot.WriteBinary(Attributes[_iter191]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class mutateRowsTs_args : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  BatchMutation _elem194;
                  _elem194 = new BatchMutation();
                  _elem194.Read(iprot);
                  RowBatches.Add(_elem194);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (RowBatches != null && __isset.rowBatches) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.Struct, RowBatches.Count));
          foreach (BatchMutation _iter199 in RowBatches)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter200 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter200);
            oprot.WriteBinary(Attributes[_iter200]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class deleteAll_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i202 = 0; _i202 < _map201.Count; ++_i202)
                {
                  byte[] _key203;
                  byte[] _val204;
                  _key203 = iprot.ReadBinary();
                  _val204 = iprot.ReadBinary();
                  Attributes[_key203] = _val204;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter205 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter205);
            oprot.WriteBinary(Attributes[_iter205]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class deleteAllTs_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i207 = 0; _i207 < _map206.Count; ++_i207)
                {
                  byte[] _key208;
                  byte[] _val209;
                  _key208 = iprot.ReadBinary();
                  _val209 = iprot.ReadBinary();
                  Attributes[_key208] = _val209;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter210 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter210);
            oprot.WriteBinary(Attributes[_iter210]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class deleteAllRow_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i212 = 0; _i212 < _map211.Count; ++_i212)
                {
                  ...
                  _val214 = iprot.ReadBinary();
                  Attributes[_key213] = _val214;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter215 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter215);
            oprot.WriteBinary(Attributes[_iter215]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  TIncrement _elem218;
                  _elem218 = new TIncrement();
                  _elem218.Read(iprot);
                  Increments.Add(_elem218);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Increments != null && __isset.increments) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (TIncrement _iter219 in Increments)
          {
  ...
  public partial class deleteAllRowTs_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i221 = 0; _i221 < _map220.Count; ++_i221)
                {
                  ...
                  _val223 = iprot.ReadBinary();
                  Attributes[_key222] = _val223;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter224 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter224);
            oprot.WriteBinary(Attributes[_iter224]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpenWithScan_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i226 = 0; _i226 < _map225.Count; ++_i226)
                {
                  ...
                  _val228 = iprot.ReadBinary();
                  Attributes[_key227] = _val228;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter229 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter229);
            oprot.WriteBinary(Attributes[_iter229]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpen_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter237 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter238 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter238);
            oprot.WriteBinary(Attributes[_iter238]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpenWithStop_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter246 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter247 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter247);
            oprot.WriteBinary(Attributes[_iter247]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpenWithPrefix_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter255 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter256 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter256);
            oprot.WriteBinary(Attributes[_iter256]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpenTs_args : TBase
  {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i261 = 0; _i261 < _map260.Count; ++_i261)
                {
                  ...
                  _val263 = iprot.ReadBinary();
                  Attributes[_key262] = _val263;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter264 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter265 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter265);
            oprot.WriteBinary(Attributes[_iter265]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public partial class scannerOpenWithStopTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter273 in Columns)
          {
      ...
      if (Attributes != null && __isset.attributes) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
          foreach (byte[] _iter274 in Attributes.Keys)
          {
            oprot.WriteBinary(_iter274);
            oprot.WriteBinary(Attributes[_iter274]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TRowResult _iter282 in Success)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (this.__isset.success) {
        if (Success != null) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
            foreach (TCell _iter286 in Success)
            {
